...
insert into producto values (8,'Ñoquis De Papa Aliada x 1 kg',1200,10,0,5,50);
insert into producto values (9,'Harina de Trigo 0/3 Seleccionada x 5 kg',1000,30,0,15,100);
insert into producto values (10,'Yerba Mate Tradicional Clasica Piporé x 500 gr',950,30,0,10,50);
...
insert into entrada_trx_pedido(id_orden, operacion, id_usuarie, id_direccion_entrega) 
values(1, 'creación', 5, 1);

insert into entrada_trx_pedido(id_orden, operacion, id_pedido, id_producto, cantidad)
values(2, 'producto', 1, 16, 2);

insert into entrada_trx_pedido(id_orden, operacion, id_pedido, id_producto, cantidad) 
values(3, 'producto', 1, 14, 4);

insert into entrada_trx_pedido(id_orden, operacion, id_pedido, id_producto, cantidad) 
values(4, 'producto', 1, 11, 1);

insert into entrada_trx_pedido(id_orden, operacion, id_pedido, fecha_hora_entrega) 
values(5, 'cierre', 1, '2023-11-17 15:30');

insert into entrada_trx_pedido(id_orden, operacion, id_pedido) 
values(6, 'entrega', 1);

insert into entrada_trx_pedido(id_orden, operacion, id_usuarie, id_direccion_entrega) 
values(7, 'creacion', 11, 2);

insert into entrada_trx_pedido(id_orden, operacion, id_pedido, id_producto, cantidad) 
values(8, 'producto', 2, 11, 4);

insert into entrada_trx_pedido(id_orden,operacion,id_pedido,fecha_hora_entrega)
values(9,'cierre',2,'2023-11-17 16:00');

insert into entrada_trx_pedido(id_orden,operacion,id_pedido,fecha_hora_entrega)
values(10,'cierre',3,'2023-11-17 13:00');

insert into entrada_trx_pedido(id_orden,operacion,id_pedido,id_producto,cantidad)
values(11,'producto',2,11,2);

insert into entrada_trx_pedido(id_orden,operacion,id_pedido,id_producto,cantidad)
values(12,'producto',2,25,2);

insert into entrada_trx_pedido(id_orden,operacion,id_pedido,id_producto,cantidad)
values(13,'producto',2,3,5);

insert into entrada_trx_pedido(id_orden, operacion, id_pedido)
values(14, 'cancelación', 2);

insert into entrada_trx_pedido(id_orden, operacion, id_pedido)
values(15, 'cancelación', 4);

insert into entrada_trx_pedido(id_orden, operacion, id_pedido)
values(16, 'cancelación', 1);
